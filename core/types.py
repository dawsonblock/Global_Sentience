...
ActionType = Literal["answer", "ask_clarification", "retrieve_memory", "write_scratchpad", "defer", "refuse_ungrounded", "repair", "summarize", "conserve_resources", "generate_principle", "internal_diagnostic"]
